...
public static class PublishedElementPropertyExtensions
{
    ...
    public static T GetPropertyValue<T>(this IPublishedElement source, [CallerMemberName] string propertyName = null)
        => source.GetPropertyValue<T>(propertyName);
    ...
    public static T GetPropertyWithDefaultValue<T>(this IPublishedElement source, T defaultValue, [CallerMemberName] string propertyName = null)
        => source.Properties.Any(p => p.Alias.Equals(propertyName)) ? source.GetPropertyValue<T>(propertyName) : defaultValue;
    ...
    public static T GetPropertyWithDefaultValue<T>(this IPublishedElement source, Func<T> defaultValueFactory, [CallerMemberName] string propertyName = null)
        => source.Properties.Any(p => p.Alias.Equals(propertyName)) ? source.GetPropertyValue<T>(propertyName) : defaultValueFactory();
}
